  ...
  this.LabelsSelect = (function() {
    function LabelsSelect() {
      ...
      $('.js-label-select').each(function(i, dropdown) {
        var $block, $colorPreview, $dropdown, $form, $loading, $newLabelCreateButton, $newLabelError, $selectbox, $sidebarCollapsedValue, $value, abilityName, defaultLabel, enableLabelCreateButton, issueURLSplit, issueUpdateURL, labelHTMLTemplate, labelNoneHTMLTemplate, labelUrl, newColorField, newLabelField, projectId, resetForm, saveLabel, saveLabelData, selectedLabel, showAny, showNo, initialSelected;
        $dropdown = $(dropdown);
        ...
        saveLabelData = function() {
          ...
          if (!_(initialSelected).isEqual(selected)) {
