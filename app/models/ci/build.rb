module Ci
  class Build < CommitStatus
    ...
    def valid_token?(token)
      # TODO (kamil): we require to check project.valid_runners_token? to maintain compatibility with older GitLab Runner versions
      # We should remove that in future release
